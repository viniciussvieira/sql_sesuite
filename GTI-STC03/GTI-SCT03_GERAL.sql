SELECT * FROM (
	WITH DADOS_SOLICITACAO AS (	
		SELECT 	WFP.IDPROCESS AS ID
				...
				--,STC03.DSTITMELHORIA::VARCHAR(255) 	AS DS_TITULO_MELHORIA
				...
				--Envolvidos / Processos / Sistemas / Áreas / Geral / Impactos Estimativas
				...
				--ESTIMATIVAS
				--,STC03.HRDESENVHORAS	AS HR_DESENV_HORAS
